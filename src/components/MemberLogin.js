...
const MemberLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Check if the user exists in the members node and not in the users node
            ...
            if (memberSnapshot.exists() && !userSnapshot.exists()) {
                ...
                setError("You are not authorized to log in as a member.");
                auth.signOut();
            }
        } catch (err) {
            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded shadow-md">
                ...
                <div className="text-center">
                    <p>
                        ...
                        <Link to="/Membersignup" className="text-blue-500 hover:underline">
                            Sign up
                        </Link>
                    </p>
                </div>
