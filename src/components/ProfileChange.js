...
const ProfileChange = () => {
                ...
                if (user) {
                    ...
                    if (memberSnapshot.exists()) {
                        ...
                        setFormData({
                            ...
                            photoUrl: memberData.photoUrl || '', // Handle case where photoUrl might be undefined
                        });
    ...
    const handlePhotoUpload = async () => {
        if (formData.photoFile) {
            const storageRef = storage.ref(`members/${auth.currentUser.uid}/profile.jpg`);
            try {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const memberRef = ref(database, `members/${auth.currentUser.uid}`);
        try {
